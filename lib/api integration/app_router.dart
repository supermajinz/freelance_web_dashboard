...
abstract class AppRouter {
  ...
  static final router = GoRouter(
    routes: [
      GoRoute(
        ...
        builder: (context, state) =>
            AuthenticationWrapper(authTokenService: DependencyInjection.provideAuthTokenService()),
      ),
      GoRoute(
        path: '/mainScreen',
    ...
    redirect: (BuildContext context, GoRouterState state) async {
      final isAuthenticated = await DependencyInjection.provideAuthTokenService().isAuthenticated();
